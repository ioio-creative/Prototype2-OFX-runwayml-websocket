...
function setupOsc(oscPortIn, oscPortOut) {
  ...
  socketOSC = io.connect('http://127.0.0.1:8081', {
    port: 8081,
...
function sendOsc(address, value) {
  ...
  if(socketOSC != undefined){
    console.log('SEND OSC address : ' + address + ' value : ' + value)
      socketOSC.emit('messageSend', [address].concat(value));
  }
